...
//! use futures_framed::{Framed, LengthDelimitedCodec};
//!
...
//! # use futures_framed::LengthDelimitedCodec;
...
//! [`AsyncRead`]: trait@futures::AsyncRead
//! [`AsyncWrite`]: trait@futures::AsyncWrite
//! [`Encoder`]: trait@Encoder
//! [`BytesMut`]: bytes::BytesMut

use super::codec::{Decoder, Encoder};
use super::framed::{Framed, FramedRead, FramedWrite};
